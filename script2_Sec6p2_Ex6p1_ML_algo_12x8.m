%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% script2_Sec6p2_Ex6p1  script file to reproduce Section 6.2, Example 6.1
%
...
% Inputs : ML algorithm data (12 x 8), algorithm parameters
% Outputs: consensus ranking, Kemeny distance, runtime
% Date   : July-2026
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

clear
fileName = 'inputData\design_ML_algos_12x8'; n = 12; k = 8;
...
if 1 == 1 
    ...
    etaList_FUR = 5; searchRad = 3;  % 12x8 (machine learning algorithm data)
...
if 1 == 1 
    ...
    SIgFURinputs.etaList_sbi = 5:5; SIgFURinputs.omega = 50;  % 12x8 (machine learning algorithm data)
    SIgFURinputs.searchRad = 3;  SIgFURinputs.etaList_FUR = 3:5; SIgFURinputs.nfold = 3;
...
baseF= pwd;
matFileSuffix = 'r2';
fileName = sprintf('pa2_script2_n_%i_k_%i_%s', n, k, matFileSuffix);
