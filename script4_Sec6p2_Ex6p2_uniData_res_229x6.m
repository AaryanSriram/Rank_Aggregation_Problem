...
% Inputs : research-centric University data (229 x 6), algorithm parameters
% Outputs: consensus ranking, Kemeny distance, runtime
% Date   : July-2026
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

clear
fileName = 'inputData\uniDataResearch_229x6'; n = 229; k = 6;
...
if 1 == 1 
    ...
    etaList_FUR = 3; searchRad = 40;  % 229x6 Research-centric 
...
baseF= pwd;
matFileSuffix = 'r2';
fileName = sprintf('pa2_script4_n_%i_k_%i_%s', n, k, matFileSuffix);
